    ...
    public String upload(MultipartFile file) {
        try {
            if (file == null || file.isEmpty())
                throw new BadRequestException("Avatar missing");
            ...
            Map uploadResult = cloudinary.uploader().upload(
                    ...
                    Map.of(
                            "folder", "avatars",
                            "resource_type", "image"
                    )//Cloudinary sẽ lưu ảnh trong thư mục:Media Library → avatars
...
//cloudinary trả về rất nhiều fields nhưng nên lưu lại secure_url để trả về frontend và public_id để khi nào cần thì xóa ảnh
//{
//        "asset_id": "...",
